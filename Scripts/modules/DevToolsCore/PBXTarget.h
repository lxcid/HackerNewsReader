...
typedef void (^PBXTargetUnknownBlockType)(void); // return type and parameters are unknown

@class DVTNotificationToken, DVTToolsVersion, NSArray, NSDictionary, NSMapTable, NSMutableArray, NSMutableDictionary, NSString, PBXFileReference, PBXProject, PBXTargetBuildContext, XCConfigurationList, XCTargetHeadermapCreationInfo, Xcode3Target;
...
- (void)propagateTargetSnapshotIfNeededWithCompletionBlock:(PBXTargetUnknownBlockType)arg1;
...
- (id)pathToLargestAssetCatalogAppIconPassingTest:(PBXTargetUnknownBlockType)arg1;
- (id)versionSettings;
...
@property(retain, nonatomic) NSString *developmentTeam;
- (id)targetKey;
