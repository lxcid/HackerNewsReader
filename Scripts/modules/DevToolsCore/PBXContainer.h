...
typedef void (^PBXContainerUnknownBlockType)(void); // return type and parameters are unknown
...
- (BOOL)enumerateReferencesUsingBlock:(PBXContainerUnknownBlockType)arg1;
