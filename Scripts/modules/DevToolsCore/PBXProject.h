...
@class DVTMacroDefinitionTable, DVTWeakInterposer, NSDate, NSHashTable, NSMapTable, NSMutableArray, NSMutableDictionary, NSSet, NSString, NSTimer, PBXFileReference, PBXGroup, XCArchiveFormat, XCConfigurationList, XCFileSystemWatcher, XCProjectHeadermapCreationInfo, XCRoots;
...
+ (instancetype)projectWithFile:(NSString * /*_Nullable*/)file;
+ (instancetype)projectWithFile:(NSString * /*_Nullable*/)file errorHandler:(id<Xcode3ProjectCreationErrorHandling> /*_Nullable*/)errorHandler;
+ (instancetype)projectWithFile:(NSString * /*_Nullable*/)file errorHandler:(id<Xcode3ProjectCreationErrorHandling> /*_Nullable*/)errorHandler readOnly:(BOOL)readOnly;
...
- (void)invalidateCachesBecauseBuildSettingsDidChangeForConfigurationNamed:(id)arg1;
- (id)userMacros;
